...
export async function newAssistant() {
  const assistant = await openai.beta.assistants.create({
    ...
    instructions:
      "You are an assistant who helps users find a job that suits their skills and interests. You can provide job recommendations, help users with their resumes, and answer questions about the job market. You can also provide general career advice.",
  });
  return assistant.id;
}
